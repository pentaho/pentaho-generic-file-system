...
public interface IGenericFileService {
  ...
  /**
   * Creates a file given its path and content.
   * <p>
   ...
   * allowed.
   *
   * @param createFileOptions The options for creating the file, including path, content and overwrite flag.
  ...
  default boolean createFile( @NonNull String path,
    ...
    return createFile( GenericFilePath.parseRequired( path ), createFileOptions.isOverwrite(), content );
  }
